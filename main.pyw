...
while True:
    ...
    # finishes ()
    if win32api.GetKeyState(SHIFT) < 0 and win32api.GetKeyState(NINE) < 0 and win32api.GetKeyState(CTRL) >= 0:
    ...
    # finishes {}
    if win32api.GetKeyState(SHIFT) < 0 and win32api.GetKeyState(LEFT_BRACKET) < 0 and win32api.GetKeyState(CTRL) >= 0:
    ...
    # finishes []
    if win32api.GetKeyState(LEFT_BRACKET) < 0 and win32api.GetKeyState(CTRL) >= 0:
        win32api.keybd_event(LEFT_BRACKET, 0, win32con.KEYEVENTF_KEYUP, 0)
        win32api.keybd_event(RIGHT_BRACKET, 0, 0, 0)
        win32api.keybd_event(RIGHT_BRACKET, 0, win32con.KEYEVENTF_KEYUP, 0)
        win32api.keybd_event(LEFT_ARROW, 0, 0, 0)
    ...
    # finishes ""
    if win32api.GetKeyState(SHIFT) < 0 and win32api.GetKeyState(APOSTROPHE) < 0 and win32api.GetKeyState(CTRL) >= 0:
    ...
    if win32api.GetKeyState(SHIFT) < 0 and win32api.GetKeyState(NINE) < 0 and win32api.GetKeyState(CTRL) < 0:
        ...
        win32api.keybd_event(SHIFT, 0, 0, 0)
        win32api.keybd_event(NINE, 0, 0, 0)
        win32api.keybd_event(NINE, 0, win32con.KEYEVENTF_KEYUP, 0)
        win32api.keybd_event(SHIFT, 0, win32con.KEYEVENTF_KEYUP, 0)
    ...
    if win32api.GetKeyState(SHIFT) < 0 and win32api.GetKeyState(LEFT_BRACKET) < 0 and win32api.GetKeyState(CTRL) < 0:
        win32api.keybd_event(CTRL, 0, win32con.KEYEVENTF_KEYUP, 0)
        win32api.keybd_event(SHIFT, 0, 0, 0)
        win32api.keybd_event(LEFT_BRACKET, 0, 0, 0)
        win32api.keybd_event(LEFT_BRACKET, 0, win32con.KEYEVENTF_KEYUP, 0)
        win32api.keybd_event(SHIFT, 0, win32con.KEYEVENTF_KEYUP, 0)
